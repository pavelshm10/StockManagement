    ...
    readonly definitions: {
        ...
        readonly ConsumesConfig: {
            ...
            readonly properties: {
                ...
                readonly include: {
                    readonly description: "Include filters for consuming shared modules.";
                    readonly type: "object";
                    readonly additionalProperties: false;
                    readonly properties: {
                        readonly version: {
                            readonly description: "Version requirement that must be satisfied for the shared module to be included.";
                            readonly type: "string";
                        };
                        readonly request: {
                            readonly description: "Request pattern that must match for the shared module to be included.";
                            readonly anyOf: readonly [{
                                readonly type: "string";
                            }, {
                ...
                readonly exclude: {
                    readonly description: "Exclude filters for consuming shared modules.";
                    readonly type: "object";
                    readonly additionalProperties: false;
                    readonly properties: {
                        readonly version: {
                            readonly description: "Version requirement that if satisfied will exclude the shared module.";
                            readonly type: "string";
                        };
                        readonly request: {
                            readonly description: "Request pattern that if matched will exclude the shared module.";
                            readonly anyOf: readonly [{
                                readonly type: "string";
                            }, {
                                readonly instanceof: "RegExp";
