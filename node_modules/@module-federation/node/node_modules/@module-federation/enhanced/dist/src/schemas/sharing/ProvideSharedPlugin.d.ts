    ...
    readonly definitions: {
        ...
        readonly ProvidesConfig: {
            ...
            readonly properties: {
                ...
                readonly include: {
                    readonly description: "Include filters for providing shared modules.";
                    readonly type: "object";
                    readonly additionalProperties: false;
                    readonly properties: {
                        readonly version: {
                            readonly description: "Version requirement that must be satisfied for the module to be provided.";
                            readonly type: "string";
                        };
                        readonly request: {
                            readonly description: "Request pattern that must match for the module to be provided.";
                            readonly anyOf: readonly [{
                                readonly type: "string";
                            }, {
                ...
                readonly exclude: {
                    readonly description: "Exclude filters for providing shared modules.";
                    readonly type: "object";
                    readonly additionalProperties: false;
                    readonly properties: {
                        readonly version: {
                            readonly description: "Version requirement that if satisfied will exclude the module from being provided.";
                            readonly type: "string";
                        };
                        readonly request: {
                            readonly description: "Request pattern that if matched will exclude the module from being provided.";
                            readonly anyOf: readonly [{
                                readonly type: "string";
                            }, {
                                readonly instanceof: "RegExp";
